...
function Card({ recipe }) {
  ...
  const hoverCardStyles = {
    ...
    transform: "scale(0.95)", // Escala ligeramente al pasar el ratón
  };
...
function Grid() {
  const recipes = [
    ...
    },
    {
      ...
      imageSrc: receta2,
      ingredients: [
        "¿Sabías que el cheesecake es uno de los postres más fáciles y rendidores? Además, se prepara con ingredientes muy baratos, tales como huevo, queso crema y galleta molida, así que este cheesecake de manzana y coco es ideal para disfrutar con una taza de café o para vender postres.",
      ],
    ...
    },
    {
      ...
      imageSrc: receta3,
      ingredients: [
        "La comida italiana es un clásico que no pasa de moda, por eso todos preparamos versiones caseras, pero igual de deliciosas para el menú de la semana o una ocasión especial.",
      ],
      instructions: ["Step 1: Do another thing", "Step 2: Do one more thing"],
    },
    {
